 ...
 */
package com.hoperun.hormachine.util.ExceptionManager;
...
import com.hoperun.hormachine.util.scan.LogUtil;
...
public class CrashHandler implements UncaughtExceptionHandler
{
    ...
    private String saveCrashInfo2File(Throwable ex)
    {
        ...
        try
        {
            ...
            String fileName = "p_mipcrash.txt";
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED))
            {
                String path = android.os.Environment.getExternalStorageDirectory().getAbsolutePath() + "/crash/";
